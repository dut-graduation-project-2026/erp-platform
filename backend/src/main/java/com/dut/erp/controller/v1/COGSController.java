...
@RequestMapping("/api/v1/organizations/{organizationId}/cogs")
public class COGSController {
  ...
  @PreAuthorize("""
      ...
      """)
  public ResponseEntity<BigDecimal> getCogsForSaleOrder(
      @PathVariable UUID organizationId,
      @PathVariable UUID saleOrderId,
      @AuthenticationPrincipal CustomUserDetails userDetails
  ) {
    return ResponseEntity.ok(stockValuationService.getCogsForSaleOrder(organizationId, saleOrderId));
  }
}
