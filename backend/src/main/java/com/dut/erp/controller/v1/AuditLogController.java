...
/**
 * Controller handling audit log retrieval. Exposes an endpoint to retrieve audit logs
 * for a specific entity (by ID and Type) within an organization.
 */
@RestController
...
public class AuditLogController {
  ...
  public ResponseEntity<PagedEntityResponse<AuditLogResponse>> getAuditLogsByEntity(
    ...
    PagedEntityResponse<AuditLogResponse> response =
        auditLogService.getAuditLogsByEntityId(
            organizationId, entityId, paginationRequest);
