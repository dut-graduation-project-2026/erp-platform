...
public class ProductController {
  ...
  /**
   * Retrieves a paginated list of products for the specified organization.
   */
  @GetMapping
  @PreAuthorize("""
  ...
  /**
   * Creates a new product in the specified organization.
   */
  @PostMapping
  @PreAuthorize("""
        @securityAuthService.hasOrganizationAccess(#organizationId, #userDetails)
  ...
  /**
   * Deletes a product from the organization.
   */
  @DeleteMapping("/{id}")
  @PreAuthorize("""
        @securityAuthService.hasOrganizationAccess(#organizationId, #userDetails)
