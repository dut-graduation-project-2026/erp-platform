            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                {isLoading ? (
                  ...
                  <tr><td colSpan={6} className="p-4 text-center text-[#898989]">No invoices found</td></tr>
                ) : (
                  filteredInvoices.map((invoice, idx) => (
                    ...
                    >
                      <td className="px-4 py-3 text-[13px] text-[#242424] font-[600] border-r border-[#e0e0e0]">{invoice.code}</td>
                      <td className="px-4 py-3 text-[13px] text-[#242424] border-r border-[#e0e0e0]">{invoice.partner?.name}</td>
                      <td className="px-4 py-3 text-[13px] text-[#242424] border-r border-[#e0e0e0]">{invoice.invoiceDate?.split('T')[0] || invoice.invoiceDate}</td>
                      ...
                      <td className="px-4 py-3 text-[13px] text-[#242424] text-right font-mono border-r border-[#e0e0e0]">₫{invoice.amountDue?.toLocaleString()}</td>
